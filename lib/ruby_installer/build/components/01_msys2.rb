...
class Msys2 < Base
  ...
  default_msys2_version = RUBY_PLATFORM=~/x64/ ? "20201109" : "20190524"
  MSYS2_VERSION = ENV['MSYS2_VERSION'] || default_msys2_version
  ...
  MSYS2_X86_64_SHA256 = "274A11559EDE8B892DA63DACAB30DCF968B811FE21CACCC9A1FB9137A5E56062"
