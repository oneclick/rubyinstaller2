...
It is based on the [MSYS2](https://www.msys2.org/) [toolchain](https://github.com/Alexpux/MINGW-packages) now, and the build scripts are rewritten from the scratch.
...
Instead RubyInstaller makes use of the [MSYS2](https://www.msys2.org/) environment for compilation of C-based gems.
